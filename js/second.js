...
const checker = (array, value) => {
    return {
        "exists": array.find(array_value => value === array_value) !== undefined,
        "index": array.findIndex(array_value => value === array_value),
        "allElementsAreNumbers": array.every(value => Number(value) !== NaN),
        "someElementsAreNumbers": array.some(value => Number(value) !== NaN)
    }
}